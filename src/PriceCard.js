        ...
        <div className="card mb-5 mb-lg-0">
          <div className="card-body">
            ...
            <ul className="fa-ul">
              ...
              <li className={props.data.isPublicProject ? "" : "text-muted"}>
                <span className="fa-li">
                  <i
                    className={
                      props.data.isPublicProject
                        ? "fas fa-check"
                        : "fas fa-times"
                    }
                  ></i>
              ...
              <li className={props.data.isPrivateProject ? "" : "text-muted"}>
                <span className="fa-li">
                  <i
                    className={
                      props.data.isPrivateProject
                        ? "fas fa-check"
                        : "fas fa-times"
                    }
                  ></i>
              ...
              <li className={props.data.isPhone ? "" : "text-muted"}>
                <span className="fa-li">
                  <i
                    className={
                      props.data.isPhone ? "fas fa-check" : "fas fa-times"
                    }
                  ></i>
                </span>
                {props.data.phone}
